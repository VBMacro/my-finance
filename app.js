...
const cycle=()=>{let d=new Date(),y=d.getFullYear(),m=d.getMonth(),start=d.getDate()>=29?new Date(y,m,29):new Date(y,m-1,29),end=new Date(start.getFullYear(),start.getMonth()+1,28);return{start,end,label:start.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})+" - "+end.toLocaleDateString("id-ID",{day:"2-digit",month:"short",year:"numeric"})}};
